...
import newSample.pages.PageInitializer;
...
public class CommonSteps extends PageInitializer {
    ...
    public static BufferedImage partialImageCreator(String imageName, int xStartPoint, int yStartPoint, int width, int height) throws IOException {

        File Screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
        BufferedImage Image = ImageIO.read(Screenshot);
        BufferedImage ImagePartial = Image.getSubimage(xStartPoint, yStartPoint, width, height);
